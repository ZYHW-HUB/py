...
# 数据集路径
dataset_path = r"D:\py\walk\gtFine"
# 原始的train, valid文件夹路径
train_dataset_path = os.path.join(dataset_path, 'train')
val_dataset_path = os.path.join(dataset_path, 'val')
test_dataset_path = os.path.join(dataset_path, 'test')
# 创建train,valid的文件夹
train_images_path = os.path.join(dataset_path, 'try_train')
val_images_path = os.path.join(dataset_path, 'try_val')
test_images_path = os.path.join(dataset_path, 'try_test')
