...
def main():
    ...
    class SimpleCNN(nn.Module):
        def __init__(self):
            ...
            # 计算展平后的维度
            flattened_image_dim = 128 * (IMG_HEIGHT // 8) * (IMG_WIDTH // 8)
            flattened_pos_dim = 2 * (IMG_HEIGHT // 8) * (IMG_WIDTH // 8)
            self.fc1 = nn.Linear(flattened_image_dim + flattened_pos_dim, 128)
